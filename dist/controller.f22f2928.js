...
const loadPokemon = async function (name) {
  try {
    ...
    const pokeData = await pokemon.json(); //console.log(pokeData.id);

    const pokeObj = await createPokemonObject(pokeData); //console.log(pokeState);
...
const loadPokemonsList = async function (link) {
  try {
    ...
    console.log(pokeData); // Insert total pokemons in the state

    pokeState.pokemonCount = pokeData.count;
    const pokemons = await Promise.all(pokeData.results.map(res => loadPokemon(res.name))); // Insert pokemon list in the state
...
const loadPokeEvoChain = async function (id) {
  ...
  const evo1 = datapok2.chain.species.name; //console.log(datapok2.chain.evolves_to[0]);
  ...
  */
  ...
  return [evolutions]; //return [evoImage1, evoImage2, evoImage3];
};
...
const loadPokemonsSearch = async function (searchString) {
  ...
  try {
    ...
    let pokeArr = Array.from(set); //pokeArr = pokeArr.splice(pokeArr.indexOf(null));

    if (pokeArr.includes(null)) pokeArr.shift();
    console.log(pokeArr); // Insert total pokemons in the state

    pokeState.pokemonCount = pokeData.count; // Insert pokemon list in the state
...
},{"regenerator-runtime":"node_modules/regenerator-runtime/runtime.js","../js/config.js":"js/config.js","./helpers.js":"js/helpers.js","./config.js":"js/config.js"}],"img/pokemon.png":[function(require,module,exports) {
...
},{"../../img/pokemon.png":"img/pokemon.png"}],"js/views/pokeListView.js":[function(require,module,exports) {
"use strict";
...
},{"./View.js":"js/views/View.js"}],"js/views/paginationView.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./View.js":"js/views/View.js"}],"js/views/pokeDetailsView.js":[function(require,module,exports) {
"use strict";
  ...
  addHandlerDetailsRender(handler) {
    ...
    /*if (!this._element) {
      window.onload = setTimeout(function () {
        const _element = document.querySelector(".card");
...
class SearchView extends _View.default {
  ...
  addHandlerSearchRender(handler) {
    this._filters.addEventListener("keyup", function () {
      const element = document.querySelector(".search--input"); //console.log(e);
      //console.log(element.value);

      let searchString = element.value; //console.log(searchString);
...
exports.default = _default;
},{"./View.js":"js/views/View.js"}],"js/views/favoritView.js":[function(require,module,exports) {
"use strict";
...
class favoritView extends _View.default {
  ...
  render(pokemon) {
    const markup = this._generateMarkup(pokemon); //this._favList.innerHTML = "";
  ...
  update(id) {
    ...
    /*if (id === this._parentElement.childNodes.dataset.id) {
      favInactive.classList.toggle("hidden");
      favActive.classList.toggle("hidden");
    }*/
...
exports.default = _default;
},{"./View.js":"js/views/View.js"}],"node_modules/core-js/internals/global.js":[function(require,module,exports) {
...
init();
},{"./model.js":"js/model.js","./views/pokeListView.js":"js/views/pokeListView.js","./views/paginationView.js":"js/views/paginationView.js","./views/pokeDetailsView.js":"js/views/pokeDetailsView.js","./views/searchView.js":"js/views/searchView.js","./views/favoritView.js":"js/views/favoritView.js","./views/View.js":"js/views/View.js","../js/config.js":"js/config.js","./helpers.js":"js/helpers.js","core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
